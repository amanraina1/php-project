        ...
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <form method="POST" action="/note">
                ...
                <div class="mt-6 flex items-center gap-x-6">
                    <a href="/notes" type="button" class=" bg-gray-500 rounded-md px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 text-gray-900">Cancel</a>
